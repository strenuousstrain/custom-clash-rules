...
const prependRule = [
  ...
  "DOMAIN-KEYWORD,yusen,DIRECT",  //屿森主线路
  ...
  "DOMAIN-SUFFIX,ct.pdtvs.com,DIRECT",  //pandacine电信优化
  "DOMAIN-SUFFIX,cu.pdtvs.com,DIRECT",  //pandacine联通优化
  "DOMAIN-SUFFIX,cm.pdtvs.com,DIRECT",  //pandacine移动优化
  "DOMAIN-SUFFIX,plusjp1.younoyes.com,DIRECT",  //younoplus日本直连
  "DOMAIN-SUFFIX,plusde1.younoyes.com,DIRECT",  //younoplus德国直连
  "DOMAIN-SUFFIX,plusus1.younoyes.com,DIRECT",  //younoplus美西直连1
  "DOMAIN-SUFFIX,plusus2.younoyes.com,DIRECT",  //younoplus美西直连2
  "DOMAIN-SUFFIX,plusus3.younoyes.com,DIRECT",  //younoplus美西直连3
  "DOMAIN-SUFFIX,plushk1.younoyes.com,DIRECT",  //younoplus香港直连
  ...
  "DOMAIN-SUFFIX,yx.emby-cm.ccwu.cc,DIRECT",  //墨云阁群友亦心通用反代-移动
  "DOMAIN-SUFFIX,yx.emby-cu.ccwu.cc,DIRECT",  //墨云阁群友亦心通用反代-联通
  ...
  "DOMAIN-SUFFIX,cu.cdn.bgp.yt,DIRECT",  //二次元ROSTELECOM分流2线路
  "DOMAIN-SUFFIX,ru-e.cdn.bgp.yt,DIRECT",  //二次元ROSTELECOM分流2线路另一个域名
  ...
  "DOMAIN-SUFFIX,eemby.cc.cd,DIRECT",  //okemby反代9
